...
import '../../model/manifestation_model.dart';
...
class _ItemDetailsState extends State<ItemDetails> {
  ...
  void initState() {
    ...
    manifestationController.checkboxValues = [];
    for (var mile
        in manifestationController.manifestationList[widget.index].mileStones) {
      manifestationController.milestoneControllers
                  ...
                  Container(
                    ...
                    child: SizedBox(
                        ...
                        child: normalButton('Save', onPressed: () async {
                          ...
                          manifestationController.makeMileListCheck();
                          print(manifestationController.mileTextList);
                          print('cjheck');
                          final manifestation = ManifestationModel(
                              manifestationController
                                  .manifestationList[widget.index].id,
                              manifestationController
                                  .manifestationList[widget.index].goalName,
                              manifestationController
                                  .manifestationList[widget.index].amount,
                              manifestationController
                                  .manifestationList[widget.index].byWhen,
                              manifestationController.mileTextList);
