                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                titleText(
                                    analyticsController
                                        .budgetList[i].budgetName,
                                    size: 20),
                                subTitleText(
                                    analyticsController.budgetList[i].date,
                                    size: 14),
